...
tickers = ["AAPL"] #["AAPL", "AMZN", "GOOG", "COST", "TSLA", "EVA", "BN", "ABBV", "CO", "PL", "CD", "AMJ"]
...
for ticker in tickers:
    ...
    data[ticker + '_SMA_200'] = compute_sma(data['Close'])#[ticker]['Close'])
...
plt.title(f"Close Price History of {tickers}")
